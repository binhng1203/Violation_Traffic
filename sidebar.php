...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link <?php echo ($current_page == 'index.php') ? '' : 'collapsed'; ?>"
      href="index.php">
  ...
  <li class="nav-item">
    <a class="nav-link <?php echo ($current_page == 'tra-cuu.php') ? '' : 'collapsed'; ?>"
    ...
    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="components-alerts.html">
          <i class="bi bi-circle"></i><span>Tra cứu vi phạm qua biển số xe</span>
        </a>
      </li>
      <li>
